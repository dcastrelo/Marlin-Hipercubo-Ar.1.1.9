...
#define MAX_BED_POWER 255 // limits duty cycle to bed; 255=full current
  ...
  #define  DEFAULT_bedKp 253.26
  #define  DEFAULT_bedKi 49.07
  #define  DEFAULT_bedKd 326.77
 ...
 * SD CARD
 *
 * SD Card support is disabled by default. If your controller has  SD slot,
 * you must uncomment the following option or it won't work.an
 *
 */
#define SDSUPPORT
